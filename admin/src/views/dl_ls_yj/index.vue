<template>
    ...
    <el-input class="w-[280px]" v-model="queryParams.name" clearable placeholder="请输入名称" />
        ...
        <el-card class="!border-none" v-loading="pager.loading" shadow="never">
            <el-button v-perms="['dl_ls_yj/add']" type="primary" @click="handleAdd">
                <template #icon>
            ...
            <div class="mt-4">
                <el-table :data="pager.lists" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="最大投注" prop="top_tz" show-overflow-tooltip />
                    <el-table-column label="最小投注" prop="low_tz" show-overflow-tooltip />
                    <el-table-column label="最低活跃用户" prop="low_user" show-overflow-tooltip />
...
<script lang="ts" setup name="dlLsYjLists">
import { usePaging } from '@/hooks/usePaging'
import { useDictData } from '@/hooks/useDictOptions'
import { apiDlLsYjLists, apiDlLsYjDelete } from '@/api/dl_ls_yj'
